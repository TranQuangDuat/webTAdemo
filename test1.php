...
<div class="box-content">
    ...
    <div id="box-listening">
        <div id="contentLeft">
            ...
            <!--Cau hoi-->
			<form method="POST" action="test2.php" autocomplete="off">
          		<div id="showbox">
                	<div class="box1">
						<h3>Question 1-6</h3>
						...
						<h2>CUSTOMER ORDER FORM</h2>
							...
							<div class="q12">
								<p id="aws1">
									...
									<input type="text" value="" required="" name="text1" >
								</p>
					
								<p id="aws2">
									<strong>Company Name 2 </strong>
									<input type="text" value="" required="" id="text2">
								</p>
							</div>
							<div class="q34">
								<p>Envelopes</p>
								<p id="aws4">
									...
									<input type="text" value="" required="" id="text4">
								</p>
							...
							<div class="q56">
								...
								<p id="aws5">
									...
									<input type="text" value="" required="" id="text5">
								</p>

								<p id="aws6">
									<strong>Quantity &nbsp; &nbsp; <b>6</b> </strong>
									<input type="text" value="" required="" id="text6">
								</p>
							</div>
					</div>
              	  <div class="box2">
					...
					<div class="q79">
						<p id="aws7">
							<strong> <b>7</b> </strong>
							<input type="text" value="" required="" id="text7">
						</p>
				
						<p id="aws8">
							<strong> <b>8</b> </strong>
							<input type="text" value="" required="" id="text8">
						</p>

						<p id="aws9">
							<strong> <b>9</b> </strong>
							<input type="text" value="" required="" id="text9">
						</p>
					</div>
				</div>
                <div class="box3">
					...
					<div class="q10">
						<p id="aws10">
							...
							<input type="text" value="" required="" id="text10">
						</p>
					</div>
				</div>
				<div class="box4">
					...
					<div id="modal-sent" class="hidden">
						<div class="box-sent" id="sent">
							<div class="menu-sent">
							...
							<div class="sent-content">
								<ul class="sent-item">
									<li class="noot1"><a href="passexam.php">Submit and View Answers</a></li>
									<li class="noot2"><a class="btn-Cancel" href="#">Cancel</a></li>
								</ul>
							</div>
						</div>
					</div>

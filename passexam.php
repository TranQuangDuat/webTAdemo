            ...
            <header>
                <nav class="navbar">
                    ...
                    <ul class="menu">
                        ...
                        <li class="navbar__item">
                            <a class="link" id="click"  href="a/index.php">
